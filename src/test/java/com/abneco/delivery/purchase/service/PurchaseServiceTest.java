...
public class PurchaseServiceTest {
    ...
    public static final ProductQuantity PURCHASE_PRODUCT1 = new ProductQuantity(PRODUCT.getId(), QUANTITY5);
    public static final ProductQuantity PURCHASE_PRODUCT2 = new ProductQuantity(PRODUCT2.getId(), QUANTITY4);
    public static final List<ProductQuantity> PRODUCT_QUANTITY_LIST = List.of(PURCHASE_PRODUCT1, PURCHASE_PRODUCT2);
